                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Webhosting</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Website Hosting</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="mt-2 pt-2 border-t border-gray-200">
                        <div className="flex flex-col md:flex-row justify-between items-center">
                            <p className="text-gray-600 mb-4 md:mb-0">© 2024 Brand, Inc. All rights reserved.</p>
